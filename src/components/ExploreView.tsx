...
import { Star, Award, TrendingUp, Calendar, Tag, Search, RefreshCw } from "lucide-react";
          ...
          <div className="border-t border-[#E5E5E5] pt-4 flex flex-wrap items-center gap-2">
            ...
            <button
              ...
              className={`px-2.5 py-1 border text-[9px] font-sans font-bold uppercase tracking-widest transition-all ${
                !selectedTag
                  ? "bg-[#F4C430] border-[#111111] text-[#111111]"
                  : "bg-white border-[#E5E5E5] text-[#8A8A8A] hover:border-[#8A8A8A]"
              }`}
            >
              all
            </button>
        ...
        <div className="space-y-6">
          {filteredProjects.map((project, idx) => {
            ...
            return (
              <div
                key={project.id}
                className="border border-[#E5E5E5] bg-white p-6 hover:border-[#111111] transition-all flex flex-col md:flex-row gap-6 justify-between items-start"
              >
                ...
                <div className="flex md:flex-col items-center gap-3 self-stretch justify-between md:justify-center border-b md:border-b-0 md:border-r border-[#E5E5E5] pb-3 md:pb-0 md:pr-6 min-w-[70px]">
                  ...
                  <button
                    ...
                    className={`flex flex-col items-center gap-1 border p-2 w-14 transition-all ${
                      isStarredByMe
                        ? "bg-[#F4C430] border-[#111111] text-[#111111]"
                        : "bg-white border-[#E5E5E5] hover:border-[#111111] text-[#8A8A8A]"
                    }`}
                  >
